...
function agregar(nueva){
    ...
    clipboard.setAttributeNS(null,"style","width:24px;height:24px");
    ...
    trash.setAttributeNS(null,"style","width:24px;height:24px");
